...
const sketchTools: Array<{
  ...
  { id: "corner", labelKey: "toolbar.corner", enabled: true },
  { id: "extend", labelKey: "toolbar.extend", hotkey: "extend", enabled: true },
  { id: "split", labelKey: "toolbar.split", enabled: true },
