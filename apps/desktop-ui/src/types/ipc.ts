...
export interface RemoveSketchProjectionsCommand {
  id: string;
  type: "remove_sketch_projections";
  payload: {
    feature_id: string;
    // false = delete every entity generated by a projection record
    // (the "Remove projections" heal); true = keep the entities and
    // drop only the live links ("Unlink projections").
